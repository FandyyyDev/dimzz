...
case 'fetch': case 'get': {
		...
		break
             ...
             kurr.sendMessage(m.chat, { image: { url: random }, caption: `© N E Z U K O - B O T` }, { quoted: m})
             break
             case 'hinata':
             m.reply(`SABAR YAAAA....`)
...
let btn = [{
    urlButton: {
        ...
        url: 'https://chat.whatsapp.com/H3Pu0j1xJyCAkD1CmrrL6Q'
    }
},  {
    quickReplyButton: {
        displayText: 'RULES',
...
let bton = [{
    ...
    urlButton: {
        ...
        url: 'https://telegra.ph/file/492d17b16adee2e3375da.jpg'
    }
}, {
    quickReplyButton: {
