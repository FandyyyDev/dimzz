...
case 'fetch': case 'get': {
		...
		break
             ...
             kurr.sendMessage(m.chat, { image: { url: random }, caption: `© AOZORA BOTZ` }, { quoted: m})
             break
             case 'hinata':
             m.reply(`SABAR YAAAA....`)
...
kurr.sendMessage(m.chat, { image: anu, caption: `© MAGER-NULIS BY NEZUKO` }, { quoted: m})
break
	    ...
	    case 'setname': case 'setsubject': {
            ...
            case 'bcimg': case 'bcvidio': case 'bcaudio': {
                ...
                for (let i of anu) {
                    ...
                    let junn = `${text}\n\n-PESAN SIARAN`
                    kurr.send5ButImg(i, junn, `nezuko`, buffer, butoon)
                    } else if (/video/.test(mime)) {
                    let junn = `${text}\n\n-PESAN SIARAN`
                    kurr.send5Vid(i, junn, `nezuko`, buffer, butoon)
...
kurr.send5ButImg(m.chat, Anu, ` MENU BOT `, fatihgans, btn)
                                          break
                                          case 'command':{
...
│➻ ${prefix}birthday
 ...
 kurr.send5ButImg(m.chat, okok, ` ALL MENU BOT `, fatihgan, butong)
                                          break
...
│➻ ${prefix}voice <option>
 ...
 kurr.send5ButImg(m.chat, okok1, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'groupmenu':
...
│➻ ${prefix}hidetag
 ...
 kurr.send5ButImg(m.chat, okok2, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'anonymousmenu':
...
│➻ ${prefix}anonymous
 ...
 kurr.send5ButImg(m.chat, okok3, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'toolsmenu':
...
│➻ ${prefix}nulis
 ...
 kurr.send5ButImg(m.chat, okok4, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'searchmenu':
...
│➻ ${prefix}wikimedia <query>
 ...
 kurr.send5ButImg(m.chat, okok5, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
  case 'downloadmenu':
...
│➻ ${prefix}mediafire <link>
 ...
 kurr.send5ButImg(m.chat, okok6, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
...
│➻ ${prefix}jodohku
 ...
 kurr.send5ButImg(m.chat, okok7, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'gamemenu':
...
│➻ ${prefix}tebak <option>
 ...
 kurr.send5ButImg(m.chat, okok8, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'ownermenu':
...
│➻ ${prefix}> / $ / => / <
 ...
 kurr.send5ButImg(m.chat, okok9, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'othermenu':
...
│➻ ${prefix}owner
 ...
 kurr.send5ButImg(m.chat, okok10, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
  case 'databasemenu':
...
│➻ ${prefix}listmsg
 ...
 kurr.send5ButImg(m.chat, okok11, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
 case 'animemenu':
...
│➻ ${prefix}nezuko
 ...
 kurr.send5ButImg(m.chat, okok12, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
case 'videomenu':
...
│➻ ${prefix}felisa
 ...
 kurr.send5ButImg(m.chat, okok09, ` Jangan Lupa Donasi `, fatihgan, butong1)
break
  case 'makermenu':
...
│➻ ${prefix}birthday                 
 ...
 kurr.send5ButImg(m.chat, okok13, ` Jangan Lupa Donasi `, fatihgan, butong1)
break          
                                          case 'block': {
                                            if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
                                            let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
